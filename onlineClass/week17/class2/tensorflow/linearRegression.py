...
def train(linear_model, x, y):
    ...
    # gradient 값 계산
    delta_W, delta_b = t.gradient(
        current_loss, [linear_model.W, linear_model.b])
...
def main():
    ...
    plt.savefig('onlineClass/week17/class2/tensorflow/data.png')
    ...
    for epoch_count in range(epochs):
        ...
        if (epoch_count % 20 == 0):
            print(
                f"Epoch count {epoch_count}: Loss value: {real_loss.numpy()}")
            print('W: {}, b: {}'.format(
            ...
            plt.savefig('onlineClass/week17/class2/tensorflow/prediction.png')
